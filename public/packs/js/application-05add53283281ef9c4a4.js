...
var map = {
	...
	"./post_controller.js": "./app/javascript/controllers/post_controller.js"
};
...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  _createClass(_default, [{
    key: "newComment",
    value: function newComment(event) {
      var response = event.detail[2].response;
    ...
    key: "prependComment",
    value: function prependComment(event) {
      var response = JSON.parse(event.detail[2].response);
...
_default.targets = ["container", "newButton", "newCommentForm", "commentList"];
...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  _createClass(_default, [{
    key: "newPostForm",
    value: function newPostForm(event) {
      var response = event.detail[2].response; // console.log(this.newPostTarget)

      this.newPostTarget.innerHTML = response; // this.hidden = true

      console.log(this.newButtonTarget);
    }
  }, {
    key: "hideForm",
    value: function hideForm() {
...
_default.targets = ["postContainer", "newPost", "newPostForm", "newButton"];
...
/******/ });
//# sourceMappingURL=application-05add53283281ef9c4a4.js.map