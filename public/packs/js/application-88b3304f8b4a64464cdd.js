...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  _createClass(_default, [{
    ...
    key: "prependPost",
    value: function prependPost(event) {
      var response = JSON.parse(event.detail[2].response);
      var link = document.createElement("a");
      link.setAttribute("href", "/posts/".concat(response.id));
      link.classList.add("d-block");
      link.innerHTML = "".concat(response.title);
      console.log(link);
      this.postContainer.prepend(link);
    }
  }]);
...
/******/ });
//# sourceMappingURL=application-88b3304f8b4a64464cdd.js.map